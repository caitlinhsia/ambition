...
export const TASKS: Record<Pool, string[]> = {
  ...
  ground: [
    ...
    "open the thing you're dreading. don't start it, just look.",
    ...
    "write the smallest next step, then stop.",
    "stand up and stretch your arms overhead.",
    "text one person that you're stressed.",
  ],
  move: [
    "10 jumping jacks.",
  ...
  rest: [
    "one stretch, then get back under the covers.",
    "close your eyes for 60 seconds.",
    "drink some water.",
    "phone down for one minute.",
    "lie down properly instead of half-slumped.",
    "put on something you've already seen.",
    "get under a blanket.",
    "set an alarm so you can stop watching the clock.",
    "eat something. anything.",
    "turn the lights down.",
    "take your shoes off and sit.",
    "no task. rest is the task.",
  ],
  bored: [
  ...
  calm: [
    "one slow breath, and notice you feel alright.",
    "tidy one small thing for future-you.",
    "write one line about today.",
    "pick a tiny thing you'd like to keep doing, and do it now.",
  ...
  savor: [
    "write down one good thing before it fades.",
  ...
  unnamed: [
    "drink some water while it sorts itself out.",
    "take one slow breath.",
    "stand up and stretch for 10 seconds.",
    "open a window.",
    "put on one song and see what happens.",
    "step outside for a minute.",
    "write whatever's in your head for 30 seconds.",
    "do one small thing you can see from where you're sitting.",
  ],
};
