...
Do it enough times and something clicks: starting stops being a wall and becomes
a **move you know** — one you can pull off without the app, without waiting to
feel ready.

## Who it's for

**Anyone, the second they notice they've stalled.** The only prerequisite is
having already thought *"yeah, I'm not starting."* Everyone's been there — the
...
```
land → "how are you landing right now?" → get ONE tiny first step
     → do it → tap done → warm, dumb little reward → "another?"
```

That's the whole app. If a teen can't explain it in one sentence, it failed.

## Why starting is the whole game (the science)
...
It teaches that **quietly, by repetition** — never a lecture. The scaffolding
fades. Leaving because you don't need it anymore is the **win**, not churn. Drift
...
## The voice: the friend who's been there

Warm, dry, lowercase. Never a cheerleader, never a scold. Its warmth shows up as
**not making a big deal of anything** — not your wins, not your absences, not
your bad days.

| moment | line |
|---|---|
| landing | hey, you made it here. rough day, or just a slow one? |
| the first step | open the doc. don't write anything. just open it. that's the whole task. |
